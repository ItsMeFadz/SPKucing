                            ...
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="artikel/create"><button class="btn btn-success add-btn"><i
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="nama_artikel">Nama Artikel</th>
                                                <th class="sort" data-sort="penulis">Penulis</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <a href="artikel/edit/{{ $item->id_artikel }}"><button
                                                                        class="btn btn-sm btn-info edit-item-btn"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#showModal">Edit</button></a>
                                                            </div>
                                                            <form id="deleteForm{{ $item->id_artikel }}"
                                                                action="/artikel/delete/{{ $item->id_artikel }}"
                                                                method="POST" class="d-inline">
                                                                @csrf
                                                                @method('DELETE')
                                                                <a href="#"
                                                                    onclick="confirmDelete({{ $item->id_artikel }})"
