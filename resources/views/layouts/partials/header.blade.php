            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg logo-right">
                            <img src="{{ asset('velzon/assets/images/pakar-logo-dark.png') }}" alt=""
                                height="22">
                        </span>
                    </a>
                    ...
                    <a href="index.html" class="logo logo-light">
                        ...
                        <span class="logo-lg logo-right">
                            <img src="{{ asset('velzon/assets/images/pakar-logo-light.png') }}" alt=""
                                height="22">
                        </span>
                    </a>
                </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="{{ asset('velzon/assets/images/users/prof.jpeg') }}" alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Selamat Datang {{ $currentUser->nama }}!</h6>
